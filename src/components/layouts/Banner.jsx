...
const Banner = () => {
  return (
    <div
      id="banner"
      className="bg-[url('/src/assets/banner.png')] bg-cover bg-center bg-no-repeat pt-52 sm:pt-64 md:pt-72 lg:pt-[400px] pb-24 sm:pb-32 md:pb-40 lg:pb-[250px] text-center px-4"
    >
